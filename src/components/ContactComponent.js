                ...
                <div className="row row-content">
                    ...
                    <div className="col-12 col-sm-11 offset-sm-1">
                        <div className="btn-group" role="group">
                            ...
                            <a role="button" className="btn btn-info" href='https://www.skype.com' rel="noopener noreferrer" target='_blank'><i className="fa fa-skype"></i> Skype</a>
                        ...
                        <LocalForm onSubmit={(values) => this.handleSubmit(values)}>
                            <Row className="form-group">
                                ...
                                <Col md={9}>
                                    ...
                                    <Errors className='pl-2 text-danger' model=".firstname" show="touched"
                                        messages={{
                                            required: 'Required',
                            ...
                            <Row className="form-group">
                                ...
                                <Col md={9}>
                                    ...
                                    <Errors className='pl-2 text-danger' model=".lastname" show="touched"
                                        messages={{
                                            required: 'Required',
                                            minLength: 'Must be greater than 2 characters',
                                            maxLength: 'Must be 15 characters or less'
                            ...
                            <Row className="form-group">
                                ...
                                <Col md={9}>
                                    <Control.text model=".telnum" id="tel" name="telnum" placeholder="Tel. Number"
                                        className="form-control"
                                        validators={{
                                            required, minLength: minLength(8), maxLength: maxLength(12), isNumber
                                        }} />
                                    <Errors className='pl-2 text-danger' model=".telnum" show="touched"
                                        messages={{
                                            required: 'Required ',
                            ...
                            <Row className="form-group">
                                ...
                                <Col md={9}>
                                    ...
                                    <Errors className='pl-2 text-danger' model=".email" show="touched"
                                        messages={{
                                            required: 'Required',
